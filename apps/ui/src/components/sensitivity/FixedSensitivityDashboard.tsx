          ...
          <div className="grid min-w-0 gap-4 2xl:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)]">
            <section className="min-w-0 rounded-lg border border-d-border bg-d-card p-4 shadow-sm">
              ...
              <fieldset
                ...
                className="min-w-0 disabled:cursor-not-allowed disabled:opacity-70"
              >
                ...
                {assumptions.length > 8 ? (
                  <button
                    ...
                    className="mt-4 w-full rounded border border-d-border px-3 py-2 text-xs font-semibold text-slate-200 transition hover:border-gold-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400"
                  >
